...
const createBook = require("../schemas/createBook.json");
const updateBook = require("../schemas/updateBook.json");
...
class Book {
  ...
  static async create(data) {
    const validatorResult = jsonschema.validate(data, createBook);
    if (validatorResult.valid) {
      ...
      const errorsList = validatorResult.errors.map((e) => e.stack);
